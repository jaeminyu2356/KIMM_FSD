...
class StartSim(Node):
    def __init__(self) -> None:
        ...
        self.city_usd_path = package_share_directory + world_config["city_usd_path"]
        ...
        self.drone_usd_path = package_share_directory + drone_config["drone_usd_path"]
        ...
        self.usd_path = package_share_directory + robot_config["usd_path"]
